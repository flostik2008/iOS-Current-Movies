...
//  MovieSelector
//
//  Created by Evgeny Vlasov on 1/3/17.
//  Copyright © 2017 Evgeny Vlasov. All rights reserved.
//

import UIKit

class MovieAnimationTransitioning: NSObject, UIViewControllerAnimatedTransitioning {
...
class MovieTransitionDelegate:NSObject, UIViewControllerTransitioningDelegate {
    ...
    func animationController(forPresented presented: UIViewController, presenting: UIViewController, source: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        let animationController = MovieAnimationTransitioning()
